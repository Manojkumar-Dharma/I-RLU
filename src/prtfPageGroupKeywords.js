 ...
 * treatment every other placeholder in this module uses. Exported
 * standalone so a future batch modeling PAGSEG's own optional `*SIZE`
 * sub-parameter (docs/AUDIT-RECORD-LEVEL.md §3) can reuse this same
 * depth/width -> rows/cols math rather than re-deriving it.
 */
